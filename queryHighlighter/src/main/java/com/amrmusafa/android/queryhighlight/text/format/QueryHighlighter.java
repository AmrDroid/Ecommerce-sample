package com.amrmusafa.android.queryhighlight.text.format;
...
import com.amrmusafa.android.queryhighlight.text.Normalizer;
...
public final class QueryHighlighter {
    ...
    public CharSequence getText( CharSequence text, CharSequence query) {
        return apply(text, query);
    }
